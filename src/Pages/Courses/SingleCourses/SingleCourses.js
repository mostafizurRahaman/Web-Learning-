   ...
   return (
      <div className='bg-violet-500  dark:bg-gray-800 p-5 rounded-md pb-16 relative card z-0'>
        ...
        <div className='font-semibold text-black dark:text-white '>
           ...
           <Link className=" bg-black text-white hover:bg-orange-500 duration-1000 transition-all w-48 text-center py-2 mx-auto block mt-5 rounded-sm dark:bg-white dark:text-black dark:hover:bg-orange-500 absolute bottom-3  right-1/2 translate-x-1/2" to={`/course/${id}`}> Show Details </Link>
        </div>
